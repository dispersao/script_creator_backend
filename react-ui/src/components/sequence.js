...
const Sequence = ({type, location, id, sceneNumber, characters, parts}) => {
  let clas= "SequenceContainer";

  return (
    <div className={clas}>
      <div className="SequenceTitle">{type.name} - {location.name} <span className="light">#{sceneNumber}</span></div>
